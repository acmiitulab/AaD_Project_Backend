...
type Endpoints interface {
	...
	GetSessionsByMovie(idParam string) func(w http.ResponseWriter,r *http.Request)
	GetSessionsByCinema(idParam string) func(w http.ResponseWriter,r *http.Request)
...
func NewEndpointsFactory(obj SessionCollection) Endpoints{
...
func (ef *endpointsFactory) GetObjects() func(w http.ResponseWriter,r *http.Request){
	return func(w http.ResponseWriter,r *http.Request){
		object, err := ef.object.GetObjects()
		if err != nil {
...
func (ef *endpointsFactory) DeleteObject(idParam string) func(w http.ResponseWriter,r *http.Request){
	return func(w http.ResponseWriter,r *http.Request){
		...
		respondJSON(w,http.StatusOK,"Session was deleted")
	}
...
func (ef *endpointsFactory) GetSessionsByMovie (idParam string)  func(w http.ResponseWriter,r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		vars:=mux.Vars(r)
		paramid, paramerr:=vars[idParam]
		if !paramerr{
		...
		id,err:=strconv.ParseInt(paramid,10,10)
		interns,err:=ef.object.GetSessionsByMovie(id)
		if err!=nil{
			respondJSON(w,http.StatusInternalServerError,err.Error())
			return
		}
...
func (ef *endpointsFactory) GetSessionsByCinema (idParam string)  func(w http.ResponseWriter,r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		vars:=mux.Vars(r)
		paramid, paramerr:=vars[idParam]
		if !paramerr{
		...
		id,err:=strconv.ParseInt(paramid,10,10)
		interns,err:=ef.object.GetSessionsByCinema(id)
		if err!=nil{
			respondJSON(w,http.StatusInternalServerError,err.Error())
			return
		}
